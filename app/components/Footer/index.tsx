    ...
    return (
      <ul className="text-gray-200 text-xl lg:text-2xl md:text-3xl">
        {navItems.map((item) => (
          <li
            key={item.title}
            className={`flex flex-col gap-y-[4px] ${pathname.toString() === item.route ? "border-b-[1px] border-white inline-flex" : ""
              }`}
          >
      ...
      <div className="px-4 lg:px-20">
        <div className="lg:flex">
          <div className="flex-1 mb-16 lg:flex lg:items-start lg:justify-start lg:flex-col">
            ...
            <div className="text-white text-xl lg:text-2xl md:text-3xl font-coolveticaLt border-b-[1px] border-white inline-block">
        ...
        <div className="flex items-center justify-center md:justify-start md:mx-12 lg:justify-start lg:mx-auto py-2 mx-auto mt-4">
          <Link href="/">
