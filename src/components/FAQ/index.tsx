  ...
  return (
    <div id="faq" className="py-16 px-4 md:py-36">
      <div className="max-w-7xl mx-auto">
        <motion.h4
          className="text-lg font-medium uppercase mb-4 flex gap-2 items-center"
        ...
        >
          <Accordion type="single" collapsible className="w-full">
            ...
            <AccordionItem value="item-3" className="py-4">
              ...
              <AccordionContent className="text-zinc-500">
                Não. A calculadora fornece uma estimativa inicial. O valor final
                é definido após análise detalhada do escopo, requisitos técnicos
