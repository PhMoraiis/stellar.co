...
export default function Stats() {
  return (
    <div className="py-16 px-4 md:py-48 flex flex-col items-center justify-center p-4 md:p-8">
      <div className="max-w-6xl mx-auto text-center">
        <div className="relative mb-16">
          <h1 className="text-2xl md:text-4xl lg:text-6xl font-movatif-regular text-[#333] space-y-3">
            Fazemos você inesquecível por meio do
            ...
            <span className="inline-flex items-center justify-center mx-2 px-4 py-2 bg-[#222] text-white rounded-full">
              <BiCodeBlock className="size-6 lg:size-8 text-primaryds mr-2" /> websites
            </span>
